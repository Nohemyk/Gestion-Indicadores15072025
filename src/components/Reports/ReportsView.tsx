...
// AHORA INCLUIMOS 'exportActivitiesToExcel' DIRECTAMENTE AQUÍ
import { exportToPDF, exportToExcel, generateExecutiveReport, generateAreaReport, exportRisksToExcel, exportActivitiesToExcel } from '../../utils/exportUtils';
    ...
    try {
      ...
      loadingMessage.innerHTML = `
        <div style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);
          ...
          <div style="margin-bottom: 10px;">Generando reporte...</div>
          <div style="width: 200px; height: 4px; background: #f0f0f0; border-radius: 2px;">
            <div style="width: 0%; height: 100%; background: #3b82f6; border-radius: 2px; animation: progress 2s ease-in-out;"></div>
          </div>
        </div>
        <style>
      ...
      switch (reportType) {
        ...
        case 'activities':
          ...
          if (format === 'PDF') {
            ...
            // Ya no necesitamos 'require', 'exportActivitiesToExcel' está importado arriba
      ...
      // Remover mensaje de progreso si existe
